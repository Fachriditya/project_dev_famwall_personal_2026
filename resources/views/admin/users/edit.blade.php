            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl">
                <div class="p-8">
                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user->id) }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        @if($user->photo)
                            <div class="flex justify-center pb-6 border-b">
                                <div class="text-center">
                                    <p class="text-sm font-semibold text-gray-700 mb-3">Foto Profil Saat Ini</p>
                                    <div class="relative inline-block">
                                        <img src="{{ asset('storage/' . $user->photo) }}" alt="{{ $user->nama }}" class="h-32 w-32 object-cover rounded-full border-4 border-primary-200 shadow-lg">
                                        <div class="absolute -bottom-2 -right-2 p-2 bg-primary-500 rounded-full">
                        ...
                        {{-- Info Password --}}
                        <div class="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 rounded-r-lg">
                            <div class="flex items-start">
                                <svg class="w-5 h-5 text-blue-500 mr-3 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                                </svg>
                                <div>
                                    <h4 class="text-sm font-semibold text-blue-800 mb-1">Informasi Password</h4>
                                    <p class="text-sm text-blue-700">
                                        Password tidak akan diubah saat update data. Gunakan tombol <span class="font-semibold">"Reset Password"</span> di halaman user list jika ingin mereset password ke default (123456).
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <label for="photo" class="block text-sm font-semibold text-gray-700 mb-2">
                                Ganti Foto Profil <span class="text-gray-500 font-normal">(Opsional)</span>
                            </label>
